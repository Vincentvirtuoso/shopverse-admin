          ...
          <>
            ...
            <AnimatePresence mode="popLayout">
              {value.map((item, index) => (
                ...
                >
                  <div
                    className={`flex items-center justify-between p-3 rounded-lg bg-gradient-to-r ${defaultStyling.itemBgGradient} border border-gray-100 dark:border-gray-700 hover:border-${defaultStyling.primaryColor}-200 dark:hover:border-${defaultStyling.primaryColor}-700 transition-colors group`}
                  >
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <div
                        className={`shrink-0 w-7 h-7 rounded-md bg-gradient-to-br ${defaultStyling.numberBadgeGradient} flex items-center justify-center shadow-sm`}
                      >
