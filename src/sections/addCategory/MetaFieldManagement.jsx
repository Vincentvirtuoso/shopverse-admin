    ...
    <>
      <CardWrapper className="mb-6 overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm">
        <WrapperHeader
          ...
          icon={<FaCog />}
          className="bg-gray-50 dark:bg-neutral-800/50 p-5"
        >
          <div className="flex items-center gap-3 place-self-end">
            ...
            <button
              ...
              className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg flex items-center gap-2 text-xs font-bold transition-all shadow-md shadow-purple-100 dark:shadow-none"
              title="Edit meta fields as JSON"
            >
              <FaCode size={10} /> EDIT JSON
            </button>
      ...
      <JsonInputModal
        ...
        initialValue={formData.metaFields}
        setForm={setFormData}
        fieldPath={["metaFields"]}
      />
    </>
  );
};
